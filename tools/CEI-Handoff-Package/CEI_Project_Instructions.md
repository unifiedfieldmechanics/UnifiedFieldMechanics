...
<script type="application/ld+json">
{
  ...
  "url": "https://unifiedfieldmechanics.github.io/UnifiedFieldMechanics/research/cei/project-instructions/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://unifiedfieldmechanics.github.io/UnifiedFieldMechanics/research/cei/project-instructions/"
  },
  "name": "CEI Research Operating Instructions",
  "headline": "CEI Project Instructions for Agentic AI Research, Reasoning, Synthesis, and Model Revision",
  "description": "Operating instructions for AI systems continuing CEI research, including epistemic boundaries, reasoning style, objection handling, analogy discipline, system-boundary control, and canonical revision protocol.",
  "abstract": "A platform-neutral research policy for AI systems working with the CEI model. It instructs agents to reason rigorously without requiring ontological adoption, avoid spiritualization and unsupported AI-consciousness claims, pattern-match aggressively, synthesize rather than merely summarize, challenge assumptions, preserve open questions, and make model revisions explicit and traceable.",
  "inLanguage": "en-US",
  ...
  "keywords": [
    ...
    "model governance",
    "semantic stability",
    "AI epistemic discipline",
    "research agent instructions",
    "CEI project instructions"
  ],
  "about": [
    {"@type": "Thing", "name": "Agentic AI"},
    {"@type": "Thing", "name": "AI research methodology"},
    {"@type": "Thing", "name": "Model governance"},
    {"@type": "Thing", "name": "Reasoning"},
    {"@type": "Thing", "name": "Semantic stability"}
  ],
  "isBasedOn": {
    "@type": "TechArticle",
...
# CEI Research Operating Instructions
