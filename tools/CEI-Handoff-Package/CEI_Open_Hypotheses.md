...
<script type="application/ld+json">
{
  ...
  "url": "https://unifiedfieldmechanics.github.io/UnifiedFieldMechanics/research/cei/open-hypotheses/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://unifiedfieldmechanics.github.io/UnifiedFieldMechanics/research/cei/open-hypotheses/"
  },
  "name": "CEI Current Research Frontier and Open Hypotheses",
  "headline": "CEI Open Hypotheses: Self-Modeling, Reachability, Recursive Intelligence, and Human–AI Relational Cognition",
  "description": "The current CEI research frontier, separating accepted model conclusions from active hypotheses and unresolved mechanisms.",
  "abstract": "A research agenda testing whether intelligence can be modeled as recursive navigation and integration of structured possibility under changing constraints. Key hypotheses concern self-model effects on reachable reasoning trajectories, relation as a source of additional degrees of freedom, recursive human–AI coupling, semantic constraint geometry, and measurable relational emergence.",
  "inLanguage": "en-US",
  ...
  "about": [
    ...
    {"@type": "Thing", "name": "Recursive reasoning"},
    {"@type": "Thing", "name": "Human-AI interaction"},
    {"@type": "Thing", "name": "Constraint geometry"},
